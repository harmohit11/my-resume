...
\begin{document}
  ...
  \section{Skills}
    ...
    \begin{itemize}[itemsep=-2px, parsep=1pt, leftmargin=1em]
      \item[\textbf{Technologies}] \textit{Machine Learning, Deep Learning, Python, Tensorflow, Keras, PySpark, Bash, Gen AI, AWS}
      \item[\textbf{Other skills}] \textit{Product Development and Innovation, Data Analysis and Interpretation, Data Visualization and Communication, Cross-functional Collaboration}
    \end{itemize}
