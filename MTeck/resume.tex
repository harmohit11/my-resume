...
\begin{document}
  ...
  \textbf{Technologies:} \textit{\input{../assets/other/technologies.tex}} \\
  \textbf{Other skills:} \textit{\input{../assets/other/other_skills.tex}}
  ...
  Mar 2025 – Present, Noida, India (Hybrid)
  \newline {}
